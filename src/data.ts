...
export const THESES_LIBRARY: ThesisNotion[] = [
  ...
  },
  {
    ...
    angles: [
      ...
      {
        these: "La langue empoisonnée : l'assimilation inconsciente de l'idéologie totalitaire",
...
export const NOTION_INTRO_DATA: Record<Notion, NotionMetadata> = {
  ...
  "La nature": {
    ...
    contexte: "D'abord perçue comme un ordre harmonieux et sacré par les Anciens, la nature devient, avec la modernité scientifique, un objet d'étude mathématique et une ressource à exploiter. Descartes propose ainsi que l'homme se rende « comme maître et possesseur de la nature ». Ce basculement a permis des progrès immenses, mais a aussi instauré une rupture entre l'humain et son environnement. En nous-mêmes, la nature s'oppose à la culture : nous sommes des êtres biologiques transformés par l'éducation et l'histoire. Aujourd'hui, face à la crise écologique, la philosophie interroge notre responsabilité : la nature n'est plus un simple décor, mais un équilibre fragile dont dépend notre propre survie."
  },
  "Le bonheur": {
    ...
    contexte: "Venu du vieux français heur (la chance ou le bon augure), le bonheur interroge le but suprême de l'existence. Les philosophies antiques le lient à la sagesse pratique et à l'exercice de la vertu, faisant du bonheur une récompense de la vie juste. Pour les Modernes, il devient une quête subjective et privée, souvent confondue avec l'accumulation de plaisirs passagers ou compromise par l'insatiabilité intrinsèque du désir humain. Kant souligne que le bonheur est un « idéal de l'imagination » plutôt qu'un concept de la raison : nous voulons tous être heureux, mais nous ignorons souvent ce qui nous comblerait réellement sur le long terme, rendant sa conquête incertaine."
  },
  "Le travail": {
    definition: "Le travail est l'activité humaine consciente et organisée par laquelle l'homme transforme la matière pour produire des biens ou des services utiles, répondant ainsi à ses besoins fondamentaux.",
    contexte: "Associé au départ à la souffrance et à la contrainte (tripalium), le travail a longtemps été méprisé au profit de la contemplation. Cependant, il est aussi le processus par lequel l'homme humanise le monde et développe ses propres facultés. Selon Hegel, c'est en travaillant que l'individu prend conscience de son pouvoir sur la nature et accède à la liberté. Pourtant, Marx dénonce l'aliénation du travailleur dans le cadre industriel, où le labeur perd son sens créatif pour devenir une simple marchandise. Aujourd'hui, entre promesse de réalisation personnelle et risque d'épuisement professionnel, le travail reste au cœur de l'identité sociale et soulève la question de la place laissée au loisir et à la pensée."
  },
  "L'État": {
    definition: "L'État est l'institution politique souveraine qui exerce son autorité sur un territoire et une population donnés, en s'appuyant sur un cadre juridique et le monopole de la violence légitime.",
    contexte: "La philosophie s'interroge sur la nécessité de l'État : est-il un protecteur nécessaire ou un oppresseur ? Pour les théoriciens du contrat social comme Hobbes ou Rousseau, l'État permet de sortir de la violence de l'état de nature en garantissant la paix et la sécurité des citoyens. En échange de sa protection, l'individu accepte de limiter sa liberté naturelle. Toutefois, pour être légitime, l'État doit viser l'intérêt général et non le profit d'une minorité. S'il peut devenir un « monstre » froid menaçant les libertés individuelles, il reste l'outil indispensable pour organiser la justice sociale et permettre la coexistence pacifique entre des individus aux intérêts souvent divergents."
  },
  "La justice": {
    definition: "La justice désigne à la fois l'exigence morale de respecter le droit d'autrui et l'institution sociale chargée d'appliquer les lois pour maintenir l'équilibre et l'équité entre les citoyens.",
    contexte: "La justice oscille entre deux pôles : la stricte égalité (donner la même chose à tous) et l'équité (donner à chacun selon ses besoins ou ses mérites). Un conflit existe souvent entre le droit positif (les lois écrites d'un État) et le droit naturel (le sentiment universel de ce qui est juste). Parfois, la loi elle-même peut être injuste, ce qui justifie pour certains la désobéissance civile. Être juste, ce n'est pas seulement obéir aux règles par peur de la punition, c'est agir par respect pour la dignité humaine. En tant qu'institution, la justice a pour mission de réparer les préjudices et de pacifier les rapports sociaux en substituant l'arbitrage de la loi à la vengeance personnelle."
  },
  "Le devoir": {
    definition: "Le devoir est une obligation morale qui s'impose à la volonté de l'individu par la raison, lui dictant d'agir selon des principes universels plutôt que selon ses penchants personnels.",
    contexte: "Le devoir se distingue de la contrainte : on obéit à une contrainte par force, mais on accomplit un devoir par choix rationnel. Kant place le devoir au centre de la morale avec son impératif catégorique : une action n'est bonne que si elle peut être érigée en loi universelle. Le devoir exige souvent de sacrifier notre plaisir immédiat au profit d'un bien supérieur ou du respect d'autrui. Il témoigne de notre liberté, car seul un être libre peut choisir de suivre une règle morale malgré ses instincts. Néanmoins, le conflit des devoirs (mentir pour protéger quelqu'un, par exemple) montre que l'application de principes rigides se heurte parfois à la complexité des situations humaines."
  },
  "La raison": {
    definition: "La raison est la faculté de l'esprit humain qui permet de lier des concepts, de porter des jugements universels, de distinguer le vrai du faux et d'organiser l'action selon des principes.",
    contexte: "Considérée comme le trait distinctif de l'homme, la raison est l'instrument de la science et de la philosophie. Elle nous permet de dépasser nos opinions subjectives pour atteindre des vérités partageables par tous. Elle possède deux visages : théorique (pour comprendre le monde) et pratique (pour guider notre conduite morale). Cependant, la raison a ses limites ; elle peut devenir purement calculatrice et oublier les valeurs humaines, ou tenter de prouver des choses qui dépassent l'expérience (comme l'existence de Dieu). Si elle est le guide de nos progrès, elle doit rester critique envers elle-même pour ne pas sombrer dans le dogmatisme ou servir des fins destructrices."
  },
  "La liberté": {
    definition: "La liberté est l'état d'un sujet qui agit sans contrainte extérieure et qui possède la capacité de choisir par lui-même, en s'appuyant sur sa raison et sa volonté propre.",
    contexte: "On oppose souvent la liberté de faire (absence d'obstacles) à la liberté de vouloir (libre arbitre). Le déterminisme affirme que nos choix sont les conséquences de causes antérieures (biologie, éducation), rendant la liberté illusoire. À l'inverse, Sartre soutient que l'homme est « condamné à être libre » car il n'a pas d'essence définie et doit se construire par ses actes. En société, la liberté n'est pas une licence totale ; elle est encadrée par la loi pour permettre la vie commune. Être libre, c'est alors être autonome, c'est-à-dire être capable de se donner ses propres lois. C'est un droit fondamental, mais aussi un fardeau, car elle implique une responsabilité totale envers nos choix."
  },
  "Le langage": {
    definition: "Le langage est un système de signes conventionnels (mots, gestes) permettant de structurer la pensée, d'exprimer une intériorité et d'assurer la communication au sein d'une communauté.",
    contexte: "Bien plus qu'un simple outil de transmission d'informations, le langage façonne notre vision de la réalité : nous pensons avec des mots. Si les animaux communiquent par des signaux instinctifs, seul l'homme dispose d'un langage capable d'abstraction et d'évocation de l'absent. Cependant, le langage est souvent critiqué pour son imprécision : les mots, généraux, échouent parfois à traduire la singularité de nos sentiments profonds. Il peut aussi être utilisé comme un instrument de pouvoir ou de manipulation. La philosophie s'interroge : le langage nous permet-il de dire la vérité du monde, ou nous enferme-t-il dans une interprétation humaine et subjective ? Parler, c'est à la fois s'ouvrir aux autres et risquer le malentendu."
  },
  "La vérité": {
    definition: "La vérité est l'accord de la pensée ou du discours avec la réalité. Elle se distingue de l'opinion par son caractère universel, nécessaire et démontrable.",
    contexte: "La recherche de la vérité est le moteur de la science et de la philosophie. Elle peut être formelle (la cohérence logique d'un raisonnement) ou matérielle (la conformité aux faits observés). Si la vérité est un idéal, elle se heurte souvent à nos illusions, nos désirs ou nos préjugés. Certains courants comme le scepticisme doutent de notre capacité à l'atteindre, tandis que le dogmatisme prétend la détenir. Aujourd'hui, la notion de vérité est malmenée par le relativisme (« à chacun sa vérité ») et la désinformation. Pourtant, elle demeure le socle indispensable du débat démocratique et de la confiance entre les hommes, car sans vérité commune, aucune entente sociale durable n'est possible."
  },
  "La science": {
    definition: "La science est un mode de connaissance rationnel, méthodique et rigoureux qui cherche à expliquer les phénomènes par des lois universelles vérifiables par l'expérience ou la démonstration.",
    contexte: "La science se sépare de la croyance par sa capacité à se remettre en question. Elle ne se contente pas d'observer, elle construit des modèles théoriques et les soumet au test de la preuve. Karl Popper souligne qu'une théorie n'est scientifique que si elle est « falsifiable », c'est-à-dire si l'on peut imaginer une expérience qui prouverait son erreur. Si elle a permis un progrès technologique sans précédent, la science soulève des questions éthiques majeures : tout ce qui est techniquement possible n'est pas forcément moralement souhaitable. Elle nous offre les moyens d'agir, mais elle ne peut pas définir les fins ou les valeurs de notre existence, laissant cette tâche à la réflexion philosophique."
  },
  "La technique": {
  ...
  "L'art": {
    ...
    contexte: "Le terme dérive du latin ars qui désignait d'abord l'adresse technique et le travail de l'artisan. L'époque moderne a séparé les beaux-arts de l'artisanat. L'art exprime la liberté de l'esprit humain capable de projeter son intériorité dans la matière. À travers l'œuvre, l'artiste réinvente notre rapport au monde et propose un sens spirituel universel. Contrairement à l'objet technique, l'œuvre d'art n'est pas faite pour être consommée ou utilisée, mais pour être contemplée. Elle nous permet de voir la réalité autrement, en révélant des émotions ou des vérités que le langage quotidien ne parvient pas à exprimer, rendant ainsi le monde plus profond et plus habitable."
  },
  "La religion": {
    definition: "La religion est un système de croyances et de pratiques rituelles qui relie une communauté autour de la reconnaissance d'un principe supérieur ou d'une dimension sacrée de l'existence.",
    contexte: "Le mot religion peut venir de religare (lier les hommes entre eux et au divin) ou de relegere (recueillir avec soin). Elle propose un cadre de sens face aux mystères de la mort, du mal et de l'origine. Si pour certains elle est une source de morale et d'espérance, pour d'autres (comme Marx ou Nietzsche), elle est une illusion qui détourne l'homme de sa liberté réelle. La philosophie interroge le rapport entre la foi (conviction sans preuve) et la raison. Dans un monde sécularisé, la religion pose la question de la coexistence entre la liberté de culte et les lois de la cité, tout en continuant de nourrir le besoin humain de transcendance et de rituels collectifs."
  },
  "Le temps": {
    definition: "Le temps est la dimension irréversible dans laquelle s'inscrit la succession des événements, marquant la séparation entre le passé, le présent et le futur.",
    contexte: "Le temps est une réalité paradoxale : s'il est mesuré objectivement par les horloges, il est vécu subjectivement comme une durée dont la vitesse varie selon nos émotions. Saint Augustin soulignait la difficulté de le définir, bien que nous en ayons une intuition immédiate. L'homme est le seul être qui sait que son temps est compté, ce qui confère à sa vie une urgence et une tragédie particulières. Nous oscillons entre le regret du passé, l'attente du futur et la difficulté d'habiter le présent. Philosopher sur le temps, c'est apprendre à accepter notre finitude et chercher à donner un sens à une existence qui, par nature, s'écoule et nous échappe continuellement."
  }
};
